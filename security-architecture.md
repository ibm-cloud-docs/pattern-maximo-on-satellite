...
| Data encryption of logs | Encrypt all operational and audit logs at rest to protect them from unauthorized disclosure | BYO encryption tool/service | BYO encryption tool/service | text |
...
{: caption="Table 7. License management architecture decisions for MAS" caption-side="bottom"}
...
{: caption="Table 1. Data encryption architecture decisions for Satellite" caption-side="bottom"}
...
{: caption="Table 2. Identity and access management architecture decisions for Satellite" caption-side="bottom"}
...
{: caption="Table 3. Application security architecture decisions for Satellite" caption-side="bottom"}
...
{: caption="Table 4. Infrastructure and endpoint architecture decisions for Satellite" caption-side="bottom"}
...
{: caption="Table 5. Threat detection and response architecture decisions for Satellite" caption-side="bottom"}
