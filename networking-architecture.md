...
{: caption="Table 1. Architecture decisions for enterprise connectivity in {{site.data.keyword.prodname_imas_short}}" caption-side="bottom"}
...
{: caption="Table 2. Architecture decisions for network segmentation and isolation in {{site.data.keyword.prodname_imas_short}}" caption-side="bottom"}
...
{: caption="Table 3. Architecture decisions for load balancing in {{site.data.keyword.prodname_imas_short}}" caption-side="bottom"}
...
{: caption="Table 4. Architecture decisions for enterprise connectivity in {{site.data.keyword.satellitelong_notm}}" caption-side="bottom"}
...
{: caption="Table 5. Architecture decisions for network segmentation and isolation in {{site.data.keyword.satellitelong_notm}}" caption-side="bottom"}
...
{: caption="Table 6. Architecture decisions for load balancing in {{site.data.keyword.satellitelong_notm}}" caption-side="bottom"}
...
{: caption="Table 7. Architecture decisions for domain name system in {{site.data.keyword.satellitelong_notm}}" caption-side="bottom"}
